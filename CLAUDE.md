...
│   └── images/                       # Hero + team photos (home-hero, about-hero, team, headshots)
├── content/
│   ├── _index.md                     # Homepage
│   ├── about.md                      # type: page
...
│   ├── _default/list.html            # Default list fallback
│   ├── _default/single.html          # Default single fallback
│   ├── index.html                    # Homepage layout
│   ├── page/single.html              # About, Contact
│   ├── page/about.html               # About page (custom layout)
