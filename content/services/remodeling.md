...
faq:
  - question: "Do I need a general contractor for a bathroom remodel in Arizona?"
    answer: "For any project with plumbing work, pulling permits, or structural changes, yes — you need a licensed contractor. Diagnostic Plumbing holds ROC #332463 (B-3 General Remodeling), which is Arizona's GC license for residential and commercial remodels, plus ROC #327364 (CR-37 Plumbing) for the plumbing trade work and ROC #327365 (CR-61 Carpentry, Remodeling & Repairs). We pull the permits, schedule inspections, and manage the full scope."
  - question: "How do drain re-routes work on a slab-foundation home?"
    answer: "We cut the slab, excavate to the existing drain line, run new drain pipe to the required location, pressure test the new line, then patch and restore the slab. The scope depends on how far the new drain needs to travel and what's in the way (post-tension cables, existing conduit). We assess this during the site visit and account for it in the written estimate — no surprises mid-project."
  - question: "Can I convert a tub to a walk-in shower? Is it complicated?"
    answer: "It's one of the most common remodel requests we get in the East Valley, and it's very doable. We remove the tub and surround, reframe the shower opening if needed, rough in the new drain and valve location (may involve a minor slab adjustment), install the shower pan or liner, and handle tile, fixtures, and glass. We walk through the full scope and fixture selection during the estimate visit."
  - question: "Should I add a water softener or RO system during a remodel?"
    answer: "A remodel is the best time to do it — walls are open, access is easy, and the cost of adding water treatment during a remodel is typically lower than a standalone installation later. East Valley hard water (Gilbert averages 13 gpg; Mesa peaks at 25 gpg) significantly shortens fixture life. We can rough in for a softener at the main line or install a dedicated RO faucet under a new kitchen sink as part of the same project."
  - question: "What does the written estimate include?"
    answer: "A line-itemized breakdown of materials, labor, and permit fees by phase. We walk through it with you before anything is signed. Scope changes — if they happen — are documented in a written change order before work continues. The contract also discloses the manufacturer warranty on fixtures and materials plus our workmanship warranty terms."
---
...
You can verify all three at the [Arizona ROC license lookup](https://roc.az.gov/).
...
**Kitchen remodels** — sink relocations, island plumbing, dishwasher add-ons, garbage disposals, and gas-line work for range installations. A kitchen remodel is also a natural time to add [under-sink reverse osmosis](/water-quality/reverse-osmosis/) while the cabinet is open and the plumber is already on-site.
...
For smaller scope work that doesn't rise to a full remodel, see [Plumbing Repairs](/services/plumbing-repairs/).
...
1. **Locate and mark.** We determine where existing drain lines run and where the new line needs to go, accounting for required slope and any structural elements (post-tension cable locations, in particular, before any cutting).
2. **Slab cut.** We cut the concrete at the required width and depth using diamond blade equipment.
3. **Excavate and re-route.** We hand-excavate to the existing line, connect the new run, and pressure-test the new pipe before anything is backfilled.
4. **Slab patch.** We backfill with compactable material, re-pour concrete, and finish to a surface condition ready for tile or flooring.
...
If a remodel also reveals that supply lines need updating — copper that has pinholed, or galvanized pipe that's restricting flow — see [Repipes](/services/repipes/) for how we handle supply line replacement, which can often be combined with remodel scope efficiently.
...
For commercial remodeling projects, see [Commercial & Hospitality](/commercial-hospitality/).
