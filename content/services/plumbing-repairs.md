...
faq:
  - question: "What does flat-rate pricing actually mean?"
    answer: "It means we give you a fixed price before we start. You know the number, you approve it, and that's what you pay — regardless of how long the repair takes. There are no hourly surprises on your invoice."
  - question: "Is the trip charge really waived?"
    answer: "Yes. If we do the work, the trip charge is waived. You pay the flat-rate price for the repair, not a trip charge on top of it. This is how honest plumbers operate, and we think you deserve to know it upfront."
  - question: "My drain is slow — is that a repair call or a drain cleaning call?"
    answer: "Slow drains are almost always a clearing issue, not a repair. Our drain cleaning service handles that. If we find a damaged pipe or fitting during the process, that's when repair work comes in. Start with drain cleaning and we'll tell you what we find. See our [Drain Cleaning](/services/drain-cleaning/) page."
  - question: "I have a slab leak. Do you handle that?"
    answer: "Yes. We perform slab leak detection and repair, including spot repairs at the leak point and full re-route if the line warrants it. For homes with recurring slab leaks or aging copper, a re-route or repipe is often the smarter long-term call. See [Repipes](/services/repipes/) for what that involves."
  - question: "What if I need a repair outside regular business hours?"
    answer: "Call us first at (480) 220-1266 — we'll do what we can. For situations that truly can't wait, see our [Emergency Plumbing](/emergency-plumbing/) page."
---
...
For homes with older copper, recurring slab leaks, or multiple problem areas, a re-route or full repipe is often the more durable long-term investment. See [Repipes](/services/repipes/) for details on what that process looks like.
...
For drain clogs and sewer line clearing, that's a drain cleaning call — see [Drain Cleaning](/services/drain-cleaning/) for what that service involves. When the issue is a broken, offset, or deteriorated sewer line, that's a repair. We handle sewer line repair for sections that can be accessed, and we'll give you a straight assessment of whether spot repair or full replacement is the right approach for your situation.
...
Same-day weekday service is available when scheduling allows. For situations that genuinely can't wait, see [Emergency Plumbing](/emergency-plumbing/).
...
Call us at **(480) 220-1266** or request service online. If you have a water heater issue, see [Water Heaters](/services/water-heaters/) — that's its own specialty with its own considerations.
