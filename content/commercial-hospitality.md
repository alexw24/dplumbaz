...
faq:
  - question: "What does a CR-37 license mean, and why does it matter for my restaurant or hotel?"
  ...
  - question: "Do you service beer lines or gas lines?"
    answer: "No. Beer line service is handled by your beverage distributor or a dedicated draught line cleaning company. Gas line work in commercial kitchens requires a separate gas-specific license; we do not perform gas line installation or repair. We handle everything on the water and drain side: kitchen drain lines, mop sinks, dish-pit connections, ice machine supply, restroom plumbing, and water heaters."
  - question: "Our restaurant drain keeps backing up every few weeks. What's actually happening?"
    answer: "Grease accumulation. Hot water and dish soap suspend the fats, oils, and grease (FOG) from kitchen operations, and it moves through the drain line — until it cools, solidifies, and restricts flow. Standard cable machines knock a hole through the blockage and leave the walls of the pipe coated. High-speed mechanical descaling removes the buildup from the pipe walls, restoring flow capacity rather than just punching through the clog. That's why the same drain that gets snaked monthly can go six months or longer after a proper mechanical cleaning. See our [high-speed drain cleaning page](/services/high-speed-drain-cleaning/) for detail on the technology."
  - question: "Can you do remodel work in a hotel guest bath between bookings?"
    answer: "Yes — and this is specifically what our carpentry and general remodeling licenses (ROC #327365 CR-61, ROC #332463 B-3) make possible. We can handle the plumbing rough-in, drywall, tile, and finish work in one coordinated crew rather than scheduling three separate trades. If you have a turnover window of a few days between bookings, we can scope the work to fit it. Talk to us before the booking gap, not during it."
...
Restaurant kitchen drain lines and bar under-bar drains are the highest-value use cases. If your kitchen drain is getting cabled every four to six weeks, one [high-speed cleaning](/services/high-speed-drain-cleaning/) followed by a scheduled maintenance interval is almost certainly a better outcome. Call us and we'll tell you honestly whether it applies to your situation.

For general drain service, see [Drain Cleaning](/services/drain-cleaning/).
...
This is not a pitch for every job — large-scale renovation projects with structural work or multiple simultaneous units involve more coordination. But for a single guest bath or a short-run refresh of a few rooms, the one-crew approach works, and the licensing to do it properly is in place. See [Remodeling](/services/remodeling/).
